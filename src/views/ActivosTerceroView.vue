                    ...
                    <div class="row mb-4">
                        ...
                        <div class="firmas-acta-container">
                            <div class="firma-acta-block">
                                <div>
                                    <button type="button" class="btn btn-danger" @click="generarActa">Generar Acta</button>
                                </div>
                                <div>
                                    <button type="button" class="btn btn-primary" @click="enviarCorreo">Enviar Correo al Tercero</button>
                                </div>
                                <div>
                                </div>
                            </div>
